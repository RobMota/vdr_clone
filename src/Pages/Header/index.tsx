...
const Header = () => {
  return (
    <div className="w-[100vw] h-[100vh] bg-black">
      <div className="bg-gradient-to-r from-[#c8fd23] to-[#91e207] w-full  h-[11vh] flex items-center justify-center ">
      ...
      <div className=" flex justify-center items-center">
        <div className="md:w-[1200px] h-[100vh]">
          ...
          >
            <div className="flex flex-col items-start h-full md:w-[600px] py-12 md:py-28 ">
              <img
                src={logo}
